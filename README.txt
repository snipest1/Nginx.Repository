...
bitnami-nginxstack-1.6.2-0-linux-installer.run on Linux or
bitnami-nginxstack-1.6.2-0-linux-x64-installer.run on Linux 64 bit.
bitnami-nginxstack-1.6.2-0-osx-x86_64-installer.dmg on OS X.
...
chmod 755 bitnami-nginxstack-1.6.2-0-linux.run
...
a regular user, or /opt/nginxstack-1.6.2-0, if you are running the 
...
/home/user/nginxstack-1.6.2-0 and that you use port 8080 for Nginx and 3306 for MySQL.
...
"Cannot open bitnami-nginxstack-1.6.2-0-linux.run: No application suitable for 
